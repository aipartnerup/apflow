...
class HttpTransport:
    ...
    def __init__(self, request_handler: Callable[[Dict[str, Any], Request], Any]):
        """
    ...
    async def handle_post(self, request: Request) -> JSONResponse:
        ...
        try:
            ...
            return JSONResponse(
                status_code=400,
                content=self._create_error_response(None, -32700, "Parse error", str(e)),
            )
    ...
    async def _handle_request(
        self, request: Dict[str, Any], http_request: Request
    ) -> Dict[str, Any]:
        """
