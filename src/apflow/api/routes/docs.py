...
class DocsRoutes:
    ...
    def __init__(
        ...
        if self.enable_docs and self.openapi_schema is None:
            self.openapi_schema = self._generate_schema(
                agent_card=agent_card, base_url=base_url, get_base_url_func=get_base_url_func
            )
    ...
    def _generate_schema(
        ...
        try:
            ...
            logger.warning(
                f"Failed to generate OpenAPI schema: {e}. Documentation will not be available."
            )
            return None
    ...
    def handle_swagger_ui(self, request: Request) -> HTMLResponse:
        ...
        try:
            ...
            return JSONResponse(
                status_code=500,
                content={"error": "Failed to serve documentation", "message": str(e)},
            )
    ...
    def handle_openapi_json(self, request: Request) -> JSONResponse:
        ...
        try:
            ...
            return JSONResponse(
                status_code=500,
                content={"error": "Failed to serve OpenAPI schema", "message": str(e)},
            )
