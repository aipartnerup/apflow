    ...
    def __init__(
        ...
        **kwargs: any,
        ...
        self._lazy_commands = {
            ...
            "monitor": ("apflow.cli.commands.monitoring", "app", "Monitor tasks and system health"),
        }
            ...
            for entry_point in entry_points:
                try:
                    ...
                    if plugin_name in registry:
                        logger.debug(
                            f"CLI plugin '{plugin_name}' already registered, skipping entry point"
                        )
                        continue
                    ...
                    logger.warning(
                        f"Failed to load CLI plugin from entry point '{entry_point.name}': {e}"
                    )
        except Exception as e:
    ...
    def format_commands(self, ctx: click.Context, formatter: click.HelpFormatter) -> None:
        ...
        for cmd_name in self.list_commands(ctx):
            ...
            if cmd_name in self._lazy_commands:
                ...
                help_text = (
                    cmd.get_short_help_str(formatter.width)
    ...
    def get_command(self, ctx: click.Context, name: str) -> click.Command | None:
        ...
        try:
            ...
            if name in registry:
                ...
                has_commands = (
                    hasattr(typer_app, "registered_commands")
                    and len(typer_app.registered_commands) > 0
                )
                ...
                is_root_command = (
                    has_commands
                    and len(typer_app.registered_commands) == 1
                    and typer_app.registered_commands[0].name is None
                )
