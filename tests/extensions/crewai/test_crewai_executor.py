...
class TestCrewaiExecutor:
    ...
    @pytest.mark.skipif(
        CrewaiExecutor is None or LLM is None, reason="CrewaiExecutor or LLM not available"
    )
    ...
    @pytest.mark.skipif(
        CrewaiExecutor is None or resolve_tool is None,
        reason="CrewaiExecutor or resolve_tool not available",
    )
    ...
    @pytest.mark.skipif(
        CrewaiExecutor is None or LLM is None or resolve_tool is None,
